...
let teamOpenings: TeamOpening[] = [
  {
    ...
    deadline: new Date(new Date().getFullYear() + 1, 1, 1),
    hackathonEndDate: new Date(new Date().getFullYear() + 1, 1, 4),
    createdAt: new Date(),
    approvedMembers: [],
    tasks: [],
  ...
  },
  {
    ...
    deadline: new Date(new Date().getFullYear() + 1, 2, 1),
    hackathonEndDate: new Date(new Date().getFullYear() + 1, 2, 4),
    createdAt: new Date(),
    approvedMembers: [],
    tasks: [],
    title: 'NYC Connect'
  },
  {
    ...
    deadline: new Date(new Date().getFullYear() + 1, 3, 1),
    hackathonEndDate: new Date(new Date().getFullYear() + 1, 3, 4),
    createdAt: new Date(),
  ...
  },
  {
    ...
    deadline: new Date(new Date().getFullYear() + 1, 4, 1),
    hackathonEndDate: new Date(new Date().getFullYear() + 1, 4, 4),
    createdAt: new Date(),
    approvedMembers: [],
    tasks: [],
  ...
  },
   {
    ...
    deadline: new Date(new Date().getFullYear() + 1, 5, 1),
    hackathonEndDate: new Date(new Date().getFullYear() + 1, 5, 4),
    createdAt: new Date(),
    approvedMembers: [],
    tasks: [],
    title: 'DeFi Future'
